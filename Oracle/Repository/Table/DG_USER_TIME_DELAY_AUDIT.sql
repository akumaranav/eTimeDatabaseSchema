-- =========================================================================================================
-- The table stores audit information for table, DG_USER_TIME_DELAY
-- A Record is created in this table if the corresponding record is updated in DG_USER_TIME_DELAY.
--  This is the before image
-- ==========================================================================================================
CREATE TABLE DG_USER_TIME_DELAY_AUDIT
(
 DGC_ID 						CHAR(20) 		NOT NULL,
 DGC_FK_COMPANY_ID				CHAR(20)		NOT NULL,
 DGC_FK_USER_TIME_DELAY_ID		CHAR(20)		NOT NULL,
